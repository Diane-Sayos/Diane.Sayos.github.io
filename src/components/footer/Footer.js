...
const Footer = () => {
    ...
    return (
        <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, p:0, display:"flex", justifyContent:"space-evenly" }} elevation={4}>
            <LinkedInIcon sx={{m:"0.5rem"}} onClick={() => window.open("https://www.linkedin.com/in/diane-sayos-briones/", "_blank")}/>
            <GitHubIcon sx={{m:"0.5rem"}} onClick={() => window.open("https://github.com/Diane-Sayos", "_blank")}/>
